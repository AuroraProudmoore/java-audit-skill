...
1. **描述**：漏洞概述，200字以内
2. **漏洞详情**：代码位置（完整绝对路径）、代码片段、详细分析
3. **修复建议**：针对具体问题的修复方案

**详细格式要求、示例、行号定位规范、分析颗粒度要求** → **见 [references/report-template.md](references/report-template.md)**
...
**详细示例见 report-template.md "分析示例"章节**。
